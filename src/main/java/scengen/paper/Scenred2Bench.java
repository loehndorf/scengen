...
import scengen.measures.DecisionProblem;
import scengen.measures.MultiNewsvendor;
import scengen.measures.PROBLEM;
import scengen.measures.RiskAverseNewsvendor;
...
public class Scenred2Bench {
	...
	static String filename = "scenred2_"+System.nanoTime()+".txt";
	static double _alpha = 0.05;
	static double[] correlation = new double[]{0.0};
	...
	static int[][] dimScens = new int[][]{{10,50}};
	static DISTRIBUTION[] dists = new DISTRIBUTION[]{DISTRIBUTION.Normal};
	static METHOD[] methods = new METHOD[]{METHOD.QuantizationGrids,METHOD.Scenred2,METHOD.VoronoiCellSampling};
